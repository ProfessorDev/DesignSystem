...
export const Badge: React.FC<BadgeProps> = ({ content, variant = "neutral", icon, iconAlignment = "left" }) => {
    ...
    return (
        <span className={twx([
            ...
            'rounded-full',
            (variant === "error" || variant === "outline-error") && "border border-red-600",
            (variant === "warning" || variant === "outline-warning") && "border border-yellow-600",
            (variant === "success" || variant === "outline-success") && "border border-green-600",
            (variant === "neutral" || variant === "outline-neutral") && "border border-gray-600",
